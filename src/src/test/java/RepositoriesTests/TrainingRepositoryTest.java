...
public class TrainingRepositoryTest {
    ...
    @Test
    public void getTrainingDataOfUserInMonthEmpty() {
        int userId = 1;
        LocalDate date = LocalDate.parse("2020-12-12");
        List<Training> expected = new ArrayList<>();
        try {
            Assert.assertEquals(expected, trainingRepository.getTrainingDataOfUserInMonth(userId, date));
        } catch (SQLException e) {
    ...
    @Test
    public void getTrainingDataOfUserInMonthNotEmpty() {
        int userId = 1;
        ...
        try {
            List<Training> actual = trainingRepository.getTrainingDataOfUserInMonth(userId, date);
